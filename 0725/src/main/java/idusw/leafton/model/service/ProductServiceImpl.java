...
public class ProductServiceImpl implements ProductService { //ProductService를 구현도를 받고 implements를 구현함
    ...
    public List<ProductDTO> searchByProductName(String name){
        List<Product> productList = productRepository.findAllByNameContaining(name, Sort.by(Sort.Direction.DESC, "name"));
    ...
    @Override
    public List<ProductDTO> searchByMainCategoryName(String name) {
        List<Product> productList = productRepository.findAllByMainCategoryNameContaining(name, Sort.by(Sort.Direction.DESC, "name"));
        List<ProductDTO> result = new ArrayList<>();
    ...
    @Override
    public List<ProductDTO> searchBySubCategoryName(String name) {
        List<Product> productList = productRepository.findAllBySubCategoryNameContaining(name, Sort.by(Sort.Direction.DESC, "name"));
        List<ProductDTO> result = new ArrayList<>();
    ...
    @Override
    public List<ProductDTO> searchByMainMaterialName(String name) {
        List<Product> productList = productRepository.findAllByMainMaterialNameContaining(name, Sort.by(Sort.Direction.DESC, "name"));
        List<ProductDTO> result = new ArrayList<>();
