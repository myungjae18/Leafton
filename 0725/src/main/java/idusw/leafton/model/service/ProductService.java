...
public interface ProductService { //ProductService 구현도
    ...
    List<ProductDTO> searchByMainCategoryName(String name);
    List<ProductDTO> searchBySubCategoryName(String name);
    List<ProductDTO> searchByMainMaterialName(String name);
}